...
class Publisher(models.Model):
    ...
    name = models.CharField(max_length=50, help_text="Input name of the Publisher")
    website = models.URLField(help_text="The Publishing company's website")
    email = models.EmailField(help_text="The publishing comapnys emails")
...
class Book(models.Model):
    ...
    title = models.CharField(max_length=70, help_text="Input name of the book")
    publication_date = models.DateField(verbose_name="Date the book wa published")
...
class Contributor(models.Model):
    ...
    first_name = models.CharField(
        max_length=50, help_text="The contributors first name"
    )
    last_name = models.CharField(max_length=50, help_text="The contributors last name")
    email = models.EmailField(max_length=200, help_text="Enter the contributor email")
...
class Review(models.Model):
    ...
    date_edited = models.DateTimeField(
        null=True, help_text="The date the review was last edited"
    )
